...
describe('Testing the includes method', () => {
  it('should return false when look for a value in an empty deque', () => {
  ...
  it('should check if a value is inside the linkedlist', () => {
    const linkedList = new Deque([6, 3, 6, 4, 1]);
  ...
  it('should check if a value in inside the linkedlist starting from an specific index', () => {
    const linkedList = new Deque([6, 4, 3, 6, 1]);
...
describe('Testing the find method', () => {
  it('should return undefined when trying to find an element inside an empty deque', () => {
  ...
  it('should return undefined then invoking the find function but the test function never met the condition', () => {
    const linkedlist = new Deque([4, 6, 2, 34, 8, 3, 1, 3]);
...
describe('Testing the some method', () => {
  it('should return false when trying to check if some values are in an empty deque', () => {
    const ll = new Deque();
...
describe('Testing the every method', () => {
  it('should return true no matter what when call the every method in an empty deque', () => {
    const ll = new Deque();
  ...
  it('should return true when checking if all values in the deque met with the condition', () => {
    const ll = new Deque([6, 4, 3, 6, 1]);
