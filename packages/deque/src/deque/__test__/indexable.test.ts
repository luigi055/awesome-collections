...
describe('Testing the at method', () => {
  ...
  it('should return each value of the deque using the at method using positive indexes', () => {
    const linkedList = new Deque(['marina', 'pedro', 'clara', 'abril']);
  ...
  it('should return each value of the deque using the at method using negative indexes', () => {
    const linkedList = new Deque([
      'someone else',
      'marina',
      'pedro',
...
describe('Testing the indexof method', () => {
  it('should return -1 when look for the index of a value an empty deque', () => {
    const linkedList = new Deque();
  ...
  it('should start looking for the index from a specific index', () => {
    const linkedList = new Deque([6, 3, 6, 4, 1, 3]);
...
describe('Testing the lastIndexOf method', () => {
  it('should return -1 when looking for the last index of the value of an empty deque', () => {
    const linkedList = new Deque();
  ...
  it('should find the last index of a specific value starting from an specified index', () => {
    const linkedList = new Deque([1, 4, 2, 3, 6, 1, 3, 4]);
